/*
 ...
 Copyright (C) 2017-2020 IOTU NICOLAE
...
const dbind = function () {
  ...
  let bindHolder; let bindingPoolDescriptor; let typeCarrier; const argsLen = arguments.length; const args0 = arguments[0]
  ...
  if (propsLen === 0) {
    ...
    let hasFunction = false; let i = 0; let propName; let propValue
...
(function () {
  ...
  Object.defineProperties(this, {
    ...
    addData: {
      ...
      get: function () {
        return function () {
          let bindHolder; let typeCarrier; let propName; let propValue; let dependencies
